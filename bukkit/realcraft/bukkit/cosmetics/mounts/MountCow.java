...
public class MountCow extends Mount {

	public MountCow(CosmeticType type){
		super(type);
	}
	...
	public Entity create(Player player){
		...
		Cow entity = (Cow)cEntity.getBukkitEntity();
		entity.setAdult();
	...
	private class CustomEntity extends EntityCow {
