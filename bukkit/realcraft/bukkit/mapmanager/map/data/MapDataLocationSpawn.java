...
public class MapDataLocationSpawn extends MapDataLocation {

	public MapDataLocationSpawn(Location location){
		this(null,location);
	}

	public MapDataLocationSpawn(String name){
		this(name,null);
	}

	public MapDataLocationSpawn(String name,Location location){
		super(name,location);
		if(location != null){
	...
	public MapDataLocationSpawn(JsonElement element){
		super(element);
	}
